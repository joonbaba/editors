...
import CheckLists from '../tools/check-list'
import EditableVoids from '../tools/editable-voids'
import Embeds from '../tools/embeds'
import ForcedLayout from '../tools/forced-layout'
import HoveringToolbar from '../tools/hovering-toolbar'
import HugeDocument from '../tools/huge-document'
import Images from '../tools/images'
import Links from '../tools/links'
import MarkdownPreview from '../tools/markdown-preview'
import MarkdownShortcuts from '../tools/markdown-shortcuts'
import Mentions from '../tools/mentions'
import PasteHtml from '../tools/paste-html'
import PlainText from '../tools/plaintext'
import ReadOnly from '../tools/read-only'
import RichText from '../tools/richtext'
import SearchHighlighting from '../tools/search-highlighting'
...
const ExamplePage = () => {
	...
	const { tools = router.asPath.replace('/tools/', '') } = router.query
	const TOOLS = TOOLS.find(e => e[2] === tools)
	const [name, Component, path] = DOC_STOOLS
	return (
		<ErrorBoundary
		...
		>
			<div>
				<Head>
					<title>Drug Medium Examples</title>
